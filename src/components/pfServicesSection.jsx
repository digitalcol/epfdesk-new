...
import { horizontalCardsPf, largeCardsPf, pastelCardsPf, pfCards, verticalCardsPf } from "@/utils/data";
...
const plans = {
  mainTitle: "Ensuring Employee Well-being: Comprehensive PT solutions",
  cards: [
    {
      ...
      <div className=" mx-auto">
        ...
        <FadeInWhenVisible>
          <VerticalAndHorizontalCards
            horizontalCards={horizontalCardsPf}
            verticalCards={verticalCardsPf}
          />
        </FadeInWhenVisible>
        <FadeInWhenVisible>
